...
Sentence 1 has 3 tokens, while sentence 2 has 5 tokens, then the model computes the mean pooling for each one: <br>
mean_pooling = average of all embeddings in the sentence <br>
<img width="237" height="77" alt="image" src="https://github.com/user-attachments/assets/8b6d6f13-ea09-4f9c-b1cd-a6a2129ae793" />

After this stage, the model can perform cos_sim to calculate the angle between the two mean_poolings.
